...
if __name__ == "__main__":
    #delimiter = "|"
    delimiter = ","
    tpath = "C:/seltests/projects/compare_configuration_files"
    target_csv = tpath + "/ALL_FWLIST.csv"
    output_sql = []
    sql_head = "INSERT INTO `linuxdroid`.`TB_TMP_PHONE_FW` (`REGION`, `VERSION`, `OS_VERSION`, `BUILD_DATE`, `CHANGE_LIST`, `UNLOCK`, `FILE_NAME`, `FILE_LINK`, `DEVICE_NAME`, `DEVICE_MODEL`, `DOWNLOAD_YN`, `KEY`) VALUES ("
    sql_tail = ")"
    ...
    file_sql = open(tpath + "/insert.sql","wb")
