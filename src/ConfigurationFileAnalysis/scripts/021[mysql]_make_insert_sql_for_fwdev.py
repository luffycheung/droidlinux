...
if __name__ == "__main__":
    #delimiter = "|"
    delimiter = ","
    tpath = "C:\\seltests\\projects\\compare_configuration_files\\scripts\\configuration_files"
    target_csv = tpath + "/../ALL_CMPOUTLIST.csv"
    output_sql = []
    sql_head = "INSERT INTO `linuxdroid`.`TB_UEVENTD_CMP_RESULT` (`FW_FILE_NAME`, `DEV_NODE`, `N_PERMISSION`, `N_USER`, `N_GROUP`, `C_PERMISSION`, `C_USER`, `C_GROUP`, `F_ONLY_IN_CUSTOM`, `F_PERMISSION_ABUSE`) VALUES ("
    sql_tail = ")"
    ...
    file_sql = open(tpath + "/../insert_cmp_result.sql","wb")
