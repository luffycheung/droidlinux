...
if __name__ == "__main__":
    ...
    strScriptsPath = os.getcwd()
    strToolsPath = strScriptsPath + "/tools"
    strLogsPath = strScriptsPath + "/logs"

    strRscPath = "/home/peter/firmwares/download_selected_firmwares"
    strTrgDirHome = strRscPath + "/target"
    strSrcDir = strRscPath + "/source"
    strConfDirHome = strRscPath + "/configuration_files"
    strBootImgToolPwd = strToolsPath + "/bootimgtools"
    strZimageToolPwd = strToolsPath + "/zImagetools"
    ...
    csvCompletedListPwd = strScriptsPath + "/extract_completed.csv"
    ...
    for i in range(0, len(tar_list),1):
        ...
        try:
            ...
            if f_status == 1:
                ...
                add_log(tar_list[i],strLogsPath)
    ...
    for i in range(0, len(zip_list),1):
        ...
        try:
            ...
            print str(e)
            add_log(zip_list[i],strLogsPath)
