 ...
 *
 *      Fixed low framerate issue
 *
 *      Classes modified:
 *          AwesomePlayer
 *
 *      Author: <paramanand.singh@stericsson.com>
 */
...
struct AwesomePlayer {
    ...
    void LOGI(const char* arg1, status_t arg2);
...
private:
    ...
    TimeSource *mAuxTimeSource;
    int64_t     mPrevAudioTimeUpdate;
    int64_t     mAVSyncCorrection;
